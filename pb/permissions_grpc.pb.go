...
type PermissionsClient interface {
	GetPermissionsConfig(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetPermissionsConfigResponse, error)
}
...
type PermissionsServer interface {
	GetPermissionsConfig(context.Context, *emptypb.Empty) (*GetPermissionsConfigResponse, error)
...
func (UnimplementedPermissionsServer) GetPermissionsConfig(context.Context, *emptypb.Empty) (*GetPermissionsConfigResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPermissionsConfig not implemented")
}
...
func _Permissions_GetPermissionsConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PermissionsServer).GetPermissionsConfig(ctx, in)
	}
...
var Permissions_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetPermissionsConfig",
			Handler:    _Permissions_GetPermissionsConfig_Handler,
		},
	},
